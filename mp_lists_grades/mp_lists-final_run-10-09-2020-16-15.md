...
```
Original: "< 2 3 1 5 6 4 7 8 >" == s.str()
Expanded: "< 2 3 1 5 6 4 7 8 >"
==
"< 1 2 3 4 5 6 7 8 >"
```
...
This report was generated for **mingw4** using **26f63d7a2a4597cf681a05d4cc6b6491b6f3e1e9** (latest commit as of **October 7th 2020, 7:00 am**)
