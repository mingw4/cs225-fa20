...
Flower::Flower(const Vector2& center)
    : stem_center(center.x(), center.y() + STEM_HEIGHT / 2),
      leaf_center(stem_center.x() - STEM_WIDTH / 2 + 1, stem_center.y() + STEM_HEIGHT / 4),
      stem(new Rectangle(stem_center, STEM_COLOR, STEM_WIDTH, STEM_HEIGHT)),
      pistil(new Circle(stem_center, PISTIL_COLOR, PISTIL_RADIUS)),
